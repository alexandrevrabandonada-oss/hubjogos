...
export const games: Game[] = [
  {
    ...
    description: 'RTS-lite arcade de defesa territorial. Despache brigadas, interrompa cascatas de infraestrutura e mantenha o bairro vivo enquanto a crise se espalha pelo mapa.',
    shortDescription: 'Despache brigadas, corte a cascata e segure o bairro vivo sob pressão sistêmica.',
    theme: 'city',
    genre: 'arcade',
    icon: '🏘️',
    cover: '/showcase/bairro-resiste/flagship-poster.svg',
    status: 'live',
    runtimeState: 'real',
    estimatedMinutes: 2,
    duration: '1-2 min',
    participants: 1,
    difficulty: 'hard',
    tags: ['arcade', 'rts-lite', 'defesa territorial', 'crise', 'resistência'],
    cta: 'Comandar Defesa',
    color: '#0f172a',
    kind: 'arcade',
  ...
  },
  {
    ...
    title: 'Corredor Livre - Tarifa Zero RJ',
    description: 'Platformer arcade de speedrun territorial. Entre no corredor do povo, atravesse bloqueios e sustente o fluxo coletivo em runs curtas e rejogaveis.',
    shortDescription: 'Platformer arcade de speedrun territorial em corrida curta.',
    theme: 'city',
    genre: 'arcade',
    icon: '🚌',
    cover: '/showcase/corredor-livre/flagship-poster.svg',
    status: 'live',
    runtimeState: 'real',
    estimatedMinutes: 3,
    duration: '30s-3 min',
    participants: 1,
    difficulty: 'easy',
    tags: ['arcade', 'platformer', 'speedrun territorial', 'tarifa zero', 'mobilidade'],
    cta: 'Jogar agora',
    color: '#1F6E8C',
    kind: 'arcade',
  ...
  },
  {
    ...
    slug: 'cidade-real',
    title: 'Cidade Real',
    description: 'Uma simulação visual-first de cidade viva: selecione intervenções, acompanhe crises e veja quatro distritos reagirem em tempo real.',
    shortDescription: 'Cidade viva, crises urbanas e reação visível no mapa',
    theme: 'city',
    genre: 'simulation',
    icon: '🏙️',
    cover: '/showcase/cidade-real/flagship-poster.svg',
    status: 'beta',
    runtimeState: 'real',
    estimatedMinutes: 7,
    duration: '5-8 min',
    participants: 1,
    difficulty: 'medium',
    tags: ['cidade', 'simulação', 'território', 'serviços públicos'],
    cta: 'Intervir',
    color: '#C97E2F',
    kind: 'simulation',
  ...
  },
  {
    ...
    deviceSupport: ['desktop'],
    priorityScore: 60,
    publicVisibility: 'lab' // Map engine is tactical but low asset spectacle compared to arcade/sim
  },
  {
  ...
  },
  {
    id: 'desobstrucao',
    slug: 'desobstrucao',
    title: 'Desobstrução - Física e Infraestrutura',
    description: 'Um vertical slice de física pesada resolvendo infraestrutura: quebre barreiras de concreto e aço para restaurar o fluxo d\'água comunitário.',
    shortDescription: 'Quebre barreiras pesadas e restaure o fluxo na marreta.',
    theme: 'labor',
    genre: 'arcade',
    icon: '🔨',
    cover: '/showcase/desobstrucao/flagship-poster.svg',
    status: 'live',
    runtimeState: 'real',
    estimatedMinutes: 2,
    duration: '1-2 min',
    participants: 1,
    difficulty: 'medium',
    tags: ['arcade', 'física', 'desobstrução', 'saneamento'],
    cta: 'Saneamento Direto',
    color: '#0a1628',
    kind: 'arcade',
    engineId: 'desobstrucao-physics-v1',
    pace: 'quick',
    line: 'trabalho',
    territoryScope: 'baixada',
    territories: ['baixada', 'estado-rj'],
    politicalThemes: ['servicos-publicos', 'trabalho', 'moradia'],
    series: 'serie-solucoes-coletivas',
    politicalAxis: 'poder-popular',
    collectiveSolutionType: 'ajuda-mutua',
    commonVsMarket: 'comum',
    campaignFrame: 'defesa-dos-comuns',
    visualVersion: 'T118-beta-v1',
    assetSet: 'desobstrucao-physics-beta',
    premiumTheme: 'desobstrucao-heavy',
    audioProfile: 'desobstrucao-impact-v1',
    season: 's1-verao-26',
    campaignRole: 'Flagship Experience',
    funRole: 'aprofundamento',
    deviceSupport: ['mobile', 'desktop'],
    isNew: true,
    priorityScore: 85,
  ...
  {
    id: 'frota-popular-spike',
    slug: 'frota-popular-spike',
    title: 'Frota Popular - Belford Roxo',
    description: 'Tycoon de gestão de frota comunitária em tempo real. Despache vans e kombis para escoar as filas das comunidades antes do colapso do rush da manhã.',
    shortDescription: 'Gerencie a frota popular e evite o colapso do transporte coletivo.',
    theme: 'city',
    genre: 'management',
    icon: '🚐',
    cover: '/games/frota-popular-spike.jpg',
    status: 'beta',
    runtimeState: 'real',
    estimatedMinutes: 4,
    duration: '3-5 min',
    participants: 1,
    difficulty: 'medium',
    tags: ['tycoon', 'gestão', 'transporte', 'frota popular', 'mobilidade'],
    cta: 'Despachar Frota',
    color: '#1E3A8A',
    kind: 'simulation',
    engineId: 'frota-popular-v1',
    pace: 'session',
    line: 'mobilidade',
    territoryScope: 'baixada',
    territories: ['baixada', 'estado-rj'],
    politicalThemes: ['transporte', 'servicos-publicos', 'organizacao-popular'],
    series: 'serie-solucoes-coletivas',
    politicalAxis: 'poder-popular',
    collectiveSolutionType: 'autogestao',
    commonVsMarket: 'comum',
    campaignFrame: 'defesa-dos-comuns',
    visualVersion: 'T138-fairness-v1',
    assetSet: 'frota-popular-spike',
    season: 's1-verao-26',
    campaignRole: 'Playtest de fairness — Belford Roxo V1 Slice.',
    funRole: 'retencao',
    deviceSupport: ['mobile', 'desktop'],
    isNew: true,
    priorityScore: 72,
