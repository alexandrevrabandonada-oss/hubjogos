...
export const QUALITY_GATES: QualityGate[] = [
  {
    ...
    check: (bp, cl) => cl.designClarityAchieved && bp.coreLoop.length > 0,
  ...
  },
  {
    ...
    check: (bp, cl) => cl.pacingAcceptable,
    requiredFor: ['vertical_slice', 'beta', 'release_candidate', 'live'],
    blocking: false,
  },
  {
    ...
    check: (bp, cl) => cl.framingPresent && bp.corePoliticalMessage.length > 0,
    requiredFor: ['vertical_slice', 'beta', 'release_candidate', 'live'],
    blocking: true,
  },
  {
    ...
    check: (bp, cl) => cl.runtimeIntegrationComplete,
    requiredFor: ['vertical_slice', 'beta', 'release_candidate', 'live'],
    blocking: true,
  },
  {
    ...
    check: (bp, cl) => cl.resultLayerComplete,
    requiredFor: ['vertical_slice', 'beta', 'release_candidate', 'live'],
    blocking: true,
  },
  {
    ...
    check: (bp, cl) => cl.mobileViable && cl.desktopViable,
  ...
  },
  {
    ...
    check: (bp, cl) => cl.noMajorUIBreaks,
    requiredFor: ['beta', 'release_candidate', 'live'],
    blocking: true,
  },
  {
    ...
    check: (bp, cl) => cl.noIdentityDrift,
    requiredFor: ['vertical_slice', 'beta', 'release_candidate', 'live'],
    blocking: true,
  },
];
